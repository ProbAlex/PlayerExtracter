...
public class Main {
    ...
    private static WebsocketNames SOCKET;
    ...
    public static void onWebhookReceived(String payload) {
        ...
        try {
            ...
            if(Player != null ) {
                SOCKET.push(resolvePlayer(payload));
            }
        } finally {}
    }
    ...
    public static String resolvePlayer(String payload){
        return getPlayerName(extractAuctioneer(getSkyblockAuction(API_KEY, extractUUID(payload))));
    }
